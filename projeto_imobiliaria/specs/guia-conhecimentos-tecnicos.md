...
Este documento cobre a base **técnica** (blockchain, tokens, segurança e metodologia de engenharia), no nível necessário para acompanhar decisões sem programar. Para regulação, compliance e modelo de negócio, veja [`specs/guia-conhecimentos-nao-tecnicos.md`](guia-conhecimentos-nao-tecnicos.md). Para quem vai efetivamente escrever os contratos em Solidity, veja [`specs/guia-conhecimentos-solidity.md`](guia-conhecimentos-solidity.md).
...
Para regulação, compliance e modelo de negócio, continue em [`specs/guia-conhecimentos-nao-tecnicos.md`](guia-conhecimentos-nao-tecnicos.md). Se você for implementar os contratos, o próximo passo é [`specs/guia-conhecimentos-solidity.md`](guia-conhecimentos-solidity.md).
