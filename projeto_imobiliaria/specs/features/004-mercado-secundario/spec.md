...
- **RNF-09**: a POC não implementa order book nem leilão — apenas listagem a preço fixo (non-goal em `specs/00-constitution.md`), reduzindo superfície de MEV/front-running (SEC-04).
