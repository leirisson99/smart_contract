...
- Oráculo automatizado de valor de aluguel — valor é lançado manualmente pelo gestor (non-goal da `specs/00-constitution.md`; risco SEC-06 aceito e documentado).
