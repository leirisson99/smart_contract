...
| RISK-12 | Investidor nunca reivindica (esquecimento) | Médio — percepção de "não recebi o rendimento" | Média | Plataforma (`specs-backend/features/001-plataforma-investidor`) executa `claim` automaticamente em nome do investidor via carteira custodial | — |
