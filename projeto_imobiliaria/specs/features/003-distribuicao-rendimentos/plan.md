...
| Backend da plataforma | Off-chain (feature 005) | Notifica investidor e pode executar `claim` em seu nome |
...
5. Plataforma notifica o investidor e reflete o saldo recebido no portfólio (feature 005).
