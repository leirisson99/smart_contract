...
| Backend da plataforma | Off-chain (`specs-backend/features/001-plataforma-investidor`) | Notifica investidor e pode executar `claim` em seu nome |
...
5. Plataforma notifica o investidor e reflete o saldo recebido no portfólio (`specs-backend/features/001-plataforma-investidor`).
...
- É consumida por `specs-backend/features/001-plataforma-investidor` (job de claim automático).
