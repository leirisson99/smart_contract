...
Este documento cobre **regulação, compliance e modelo de negócio**. Para os fundamentos técnicos (blockchain, tokens, segurança, metodologia de engenharia), veja [`specs/guia-conhecimentos-tecnicos.md`](guia-conhecimentos-tecnicos.md).
...
Para os fundamentos técnicos (blockchain, tokens, segurança de smart contracts, metodologia de engenharia), continue em [`specs/guia-conhecimentos-tecnicos.md`](guia-conhecimentos-tecnicos.md).
