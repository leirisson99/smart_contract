...
- `specs/features/001-identidade-kyc/spec.md`
- `specs/decisions/ADR-0006-fronteira-onchain-offchain-kyc.md`
...
- `specs/decisions/ADR-0001` a `ADR-0005`
- Todos os `specs/features/00{1,2,3,4}-*/spec.md`, `plan.md` e `contracts/*.md`
- Todos os `specs/features/00{1,2,3,4}-*/test-strategy.md`
...
**Entregas da fase:** contratos `IdentityRegistry`, `ComplianceModule`, `PropertyToken`, `PropertyFactory`, `DividendDistributor`, `Marketplace` implementados e testados; `specs/security-checklist.md` 100% verificado; auditoria de segurança externa contratada e concluída.
...
**Pré-requisitos:**
- `specs/security-checklist.md` 100% concluído + relatório de auditoria externa sem findings críticos em aberto
- `specs/features/*/risks.md` revisados com mitigação aplicada ou risco formalmente aceito
