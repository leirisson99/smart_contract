...
8. [ ] Testes de componente e end-to-end conforme `test-strategy.md` (depende do backend, `specs-backend/features/001-plataforma-investidor`, com endpoints disponíveis).
