...
- **Compliance Module pluggável**: regras de transferência (quem pode receber cotas, limites, lockups) ficam isoladas em um contrato separado, testável de forma independente — alinhado ao princípio de simplicidade da `../00-constitution.md`.
