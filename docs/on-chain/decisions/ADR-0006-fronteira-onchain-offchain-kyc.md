...
- Impacto em specs de feature relacionadas: `../features/001-identidade-kyc` (spec completa do fluxo), `../../backend/features/001-onboarding-e-custodia` (armazenamento de PII off-chain, LGPD).
