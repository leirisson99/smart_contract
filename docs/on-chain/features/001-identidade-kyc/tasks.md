...
8. [~] Checklist de segurança: SEC-02, SEC-08, SEC-10, SEC-11 marcados como mitigados em `../../security-checklist.md`. Só SEC-10 mitigado nesta etapa — SEC-02/08/11 dependem de itens fora do escopo desta feature (contratos 002/004 e contratação do provedor de KYC).
