...
- Implementação de referência ERC-3643 (T-REX) — `IdentityRegistry`/`ClaimTopicsRegistry`/`TrustedIssuersRegistry` como inspiração de design (aqui simplificados em um único contrato para a POC, conforme princípio de simplicidade da `../../../00-constitution.md`).
