...
A compra de cotas precisa de uma moeda de liquidação on-chain. Duas opções levantadas para validação com stakeholders (rastrear em `../../roadmap.md`, tracker de perguntas):
