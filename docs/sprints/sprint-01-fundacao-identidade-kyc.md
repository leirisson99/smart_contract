...
**Feature `001-identidade-kyc`** (backlog completo em [`../on-chain/features/001-identidade-kyc/tasks.md`](../on-chain/features/001-identidade-kyc/tasks.md)):
...
- [x] Escrever testes de `IdentityRegistry` (unit + fuzz) a partir de [`contracts/identity-registry.md`](../on-chain/features/001-identidade-kyc/contracts/identity-registry.md). (`test/IdentityRegistry.t.sol`, 15 testes cobrindo RF-02, RF-04, RF-05 e o cenário de remoção de Trusted Issuer.)
...
- [x] Escrever testes de `ComplianceModule` a partir de [`contracts/compliance-module.md`](../on-chain/features/001-identidade-kyc/contracts/compliance-module.md). (`test/ComplianceModule.t.sol`, 11 testes cobrindo KYC, limite de holders e o invariante "nunca permite sem KYC" via fuzz.)
