...
Backlog completo em [`tasks.md`](../on-chain/features/003-distribuicao-rendimentos/tasks.md):
- [x] Escrever testes de `DividendDistributor` a partir de [`contracts/dividend-distributor.md`](../on-chain/features/003-distribuicao-rendimentos/contracts/dividend-distributor.md). (`test/DividendDistributor.t.sol`, 15 testes cobrindo RF-11 a RF-15, dust e o cenário "transferência entre ciclos".)
...
Backlog completo em [`tasks.md`](../on-chain/features/004-mercado-secundario/tasks.md):
- [x] Escrever testes de `Marketplace` a partir de [`contracts/marketplace.md`](../on-chain/features/004-mercado-secundario/contracts/marketplace.md). (`test/Marketplace.t.sol`, 19 testes cobrindo RF-16 a RF-20, taxa de transação e concorrência.)
